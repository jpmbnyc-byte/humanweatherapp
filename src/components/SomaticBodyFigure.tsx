...
const BODY_TILE_BANDS: readonly TileBand[] = [
  [1, [7, 8]], [2, [6, 9]], [3, [6, 9]], [4, [7, 8]],
  [5, [4, 11]], [6, [3, 12]], [7, [3, 12]], [8, [3, 12]],
  [9, [4, 11]], [10, [4, 11]], [11, [4, 11]], [12, [4, 11]],
  [13, [5, 10]], [14, [5, 7, 8, 10]], [15, [5, 7, 8, 10]],
  [16, [5, 7, 8, 10]], [17, [5, 7, 8, 10]], [18, [5, 7, 8, 10]],
  [19, [4, 7, 8, 11]],
] as const;
...
function HandContours({ side, ink }: { side: "left" | "right"; ink: string }) {
  ...
  return (
    <g transform={flip} fill="none" stroke={ink} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8 51.7C5.5 51 3.7 51.3 2.2 52.2C1.2 52.9 1.6 54 2.8 54.1L7.8 54" strokeWidth="0.58" />
      <path d="M7.8 54L2.2 55.3M7.9 55.1L2.8 57M8.2 56.2L4 58.3M8.6 57L5.4 59.1" strokeWidth="0.5" />
...
function FootContours({ side, ink }: { side: "left" | "right"; ink: string }) {
  ...
  return (
    <g transform={flip} fill="none" stroke={ink} strokeLinecap="round" strokeLinejoin="round">
      <path d="M44 88C43.7 91.5 41.7 93.2 38.5 94.5C36.8 95.2 37.2 96.6 39.2 96.8H47.8" strokeWidth="0.72" />
      <path d="M38.8 94.5L38.4 96M40.7 93.8L40.5 96.3M42.7 92.9L42.6 96.4M44.6 91.8L44.7 96.5M46.3 90.8L46.6 96.5" strokeWidth="0.42" />
...
export default function SomaticBodyFigure({ currentTheme }: Props) {
  ...
  return (
    ...
    >
      ...
      <g transform="translate(18 4) scale(4 4.55)" fill={ink} opacity={tileOpacity} filter={`url(#${glowId})`}>
        {BODY_TILES.map(tile => (
